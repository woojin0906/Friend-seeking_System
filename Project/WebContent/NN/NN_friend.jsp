            ...
            <div class="col-12">
              ...
              <div class="table-div">
                <table>
                  ...
                  Meal meal = null;
	              	try {
	              		String sql = "select * from meal"; // SQL 쿼리
	              		...
	              		while(rs.next()) {
	              			...
	              			meal.setSex(rs.getString("_sex"));
	              			meal.setDrink(rs.getString("_drink"));
	              			meal.setDest(rs.getString("_dest"));
	              			meal.setMain(rs.getString("_main"));
	              			meal.setCategory(rs.getString("_category"));
	              			//meal.setAge(rs.getage("_age"))
                  %>
           					 <tr>
           					 	  <td><%= meal.getNickName()%></td> <!-- 작성자 -->
			                      <td><%= meal.getTitle() %></td> <!-- 제목 -->
			                      <td><%= meal.getCategory() %></td> <!-- 메뉴 한&일&양&중&등 -->
			                      <td><%= meal.getSex() %></td> <!-- 성별 -->
			                      <td><%= meal.getCount() %></td> <!-- 인원 -->
			                      <td><%= meal.getDrink() %></td> <!-- 음주여부 -->
			                      <td><%= meal.getDest() %></td> <!-- 장소 -->
			                      <td><%= meal.getPromiseTime() %></td> <!-- 시간 -->
			                      <td><%= meal.getMain() %></td> <!-- 기타내용 -->
