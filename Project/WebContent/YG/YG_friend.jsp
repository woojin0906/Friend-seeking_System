            ...
            <div class="col-12">
              ...
              <div class="table-div">
                <table>
                  ...
                  Study study = null;
	              	try {
	              		String sql = "select * from study"; // SQL 쿼리
	              		...
	              		while(rs.next()) {
	              			...
	              			study.setSex(rs.getString("_sex"));
	              			study.setDest(rs.getString("_dest"));
	              			study.setMain(rs.getString("_main"));
	              			study.setCategory(rs.getString("_category"));
	              			
                  %>
           					 <tr>
           					      <td><%= study.getTitle() %></td> <!-- 제목 -->
           					 	  <td><%= study.getNickName()%></td> <!-- 작성자 -->
           					 	  <td><%= study.getCategory() %></td> <!-- 공부주제 -->
			                      <td><%= study.getSex() %></td> <!-- 성별 -->
			                      <td><%= study.getCount() %></td> <!-- 인원 -->
			                      <td><%= study.getDest() %></td> <!-- 장소 -->
			                      <td><%= study.getPromiseTime() %></td> <!-- 시간 -->
			                      <td><%= study.getMain() %></td> <!-- 기타내용 -->
